...
import Login from '/home/whitney/my-app-frontend/src/container/Login.js'
import Projects from '/home/whitney/my-app-frontend/src/container/Projects.js'
import ProjectDashboard from '/home/whitney/my-app-frontend/src/container/ProjectDashboard.js'
import Layout from '/home/whitney/my-app-frontend/src/container/Layout.js'
...
const App = () => {
  ...
  const handleDeleteProject = (deleteProject) => {
    ...
    fetch(`"http://localhost:9292/${deleteProject.id}`, {
      method: 'DELETE',
    })
